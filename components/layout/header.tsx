      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex h-16 items-center justify-between">
                ...
                <div className="flex flex-col gap-4 py-6">
                  ...
                  {user && (
                    <div className="pt-4 border-t space-y-2">
                      <Button variant="ghost" className="justify-start w-full" onClick={() => router.push("/account")}>
                        My Account
                      </Button>
                      <Button variant="ghost" className="justify-start w-full" onClick={() => router.push("/wishlist")}>
                        Wishlist
                      </Button>
                      {user.role === "seller" && (
                        <Button variant="ghost" className="justify-start w-full" onClick={() => router.push("/seller")}>
                          Seller Dashboard
                        </Button>
                      )}
          ...
          <div className="flex items-center gap-1 sm:gap-2">
            ...
            <Button variant="ghost" size="icon" className="hidden sm:flex" onClick={() => router.push("/wishlist")}>
